...
<div class="row">
   ...
   <div class="span6">
      <h2>登入</h2>
      <form class="well login" action="<?php echo Uri::create('user/login'); ?>" method="post" accept-charset="utf-8">
   ...
   <div class="span6">
      <h2>註冊</h2>
      <form class="well register" action="<?php echo Uri::create('user/register/'); ?>" method="post" accept-charset="utf-8">
